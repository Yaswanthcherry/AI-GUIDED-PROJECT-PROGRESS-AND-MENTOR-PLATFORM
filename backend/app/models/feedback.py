...
class FacultyFeedback(Base):
    ...
    faculty_id: Mapped[str] = mapped_column(String(36), ForeignKey("users.id", ondelete="CASCADE"), index=True, nullable=False)
    type: Mapped[str] = mapped_column(String(24), nullable=False)  # message, feedback, recommendation, task_suggestion
